 ...
 * @since 1.0.0
 */
function algori_pdf_viewer_cgb_block_assets() { // phpcs:ignore
	...
	register_block_type(
		'algori-pdf-viewer/block-algori-pdf-viewer', array(
			...
			'editor_script' => 'algori_pdf_viewer-cgb-block-js',
			// Enqueue blocks.editor.build.css in the editor only.
			'editor_style'  => 'algori_pdf_viewer-cgb-block-editor-css',
		)
	);
}

// Hook: Block assets.
add_action( 'init', 'algori_pdf_viewer_cgb_block_assets' );
